...
if __name__ == "__main__":
    ...
    # get datasets
    from data import getDatasetRosenbrock
    data_train, data_test, data_dev = getDatasetRosenbrock(num_data=num_data, num_vars=num_vars,
    ...
    # params
    p = np.random.uniform(0.5, 6.0, 1)
    a = np.random.uniform(0.2, 1.2, num_vars-1)
    ...
    model = exactRosenbrock(n_vars=num_vars, n_integers=0)
