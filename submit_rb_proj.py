...
import run
print("Rosenbrock")
#run.rosenbrock_proj.rndCls(loader_train, loader_test, loader_val, config)
#run.rosenbrock_proj.rndThd(loader_train, loader_test, loader_val, config)
print(config)
...
executor.update_parameters(slurm_additional_parameters={"account": "def-khalile2",
                           ...
                           cpus_per_task=16,
                           gpus_per_node=1)
job = executor.submit(run.rosenbrock_proj.rndCls, loader_train, loader_test, loader_val, config)
...
executor.update_parameters(slurm_additional_parameters={"account": "def-khalile2",
                           ...
                           cpus_per_task=16,
                           gpus_per_node=1)
job = executor.submit(run.rosenbrock_proj.rndThd, loader_train, loader_test, loader_val, config)
print(f"Submitted job with ID: {job.job_id}")
