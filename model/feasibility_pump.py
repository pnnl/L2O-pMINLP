...
def feasibilityPumpModel(param_keys, getProb, sol_func, rnd_layer, int_ind, num_iters):
    ...
    sol_map = nm.system.Node(sol_func, param_keys, ["x_bar_0"], name="smap") # mapping
    ...
    for i in range(num_iters):
        ...
        round_func = roundModel(layers=rnd_layer, param_keys=param_keys,
...
if __name__ == "__main__":
    ...
    feasibilityPumpModel(["p", "a"], getProb, sol_func, rnd_layer, int_ind=model.int_ind, num_iters=10)
